...
<body>
                    ...
                    <div class="card p-2">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="cpf" type="text" placeholder="Insira somente números"
                                    pattern="[0-9]" autocomplete="off" minlength="14" maxlength="14" required>
                            </div>
                            <div class="col-md-12">
                                <label class="form-label">Endereço<span style="color:red">*</span></label>
                                <input class="form-control" id="endereco" type="text"
                                    placeholder="Ex: Avenida Jose Bueno 680">
                            </div>
                            <div class="col-md-6">
    ...
    <div class="progress" style="position: fixed; top: 0; height: 5px;">
        <div id="progress" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar"
            aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width: 100%; height: 5px;"></div>
    </div>
    <div class="container my-3">
        <a href="http://localhost:80/GlobalDotCom/www.gaussfleet.com/index.html "><img id="logo" class="text-center"
    ...
    <div class='container p-3'>
        ...
        <!--botao saie-->
        <button class='btn btn-danger' onclick="logout()" id="myBtn"
            style="text-align: right; float: right;">Sair</button>
        <!-- Botao adicinoar veiculo -->
        <button class='btn btn-theme' id="addVeiculo" onclick="addVeiculo()"
