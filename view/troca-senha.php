...
<!--<form>
  ...
  <div class="inputGroup inputGroup1">
    ...
    <input type="email" id="loginEmail" maxlength="254" autocomplete="off" placeholder="email" style="font-size: 16px;"/>
  </div>
  <div class="inputGroup inputGroup2">
    <label for="loginPassword" id="loginPasswordLabel">Password</label>
    <input type="password" id="loginPassword" style="font-size: 16px;"/>
  ...
  <div class="inputGroup inputGroup3">
    <button id="login">Atualizar senha</button>
  </div>  
</form>
  </form>
...
function trocaSenha(){
  ...
  $.ajax({
    url: "http://localhost:8080/GlobalDotCom/index.php",
    type: "POST",
    data: {
      email: email,
      senha: senha,
