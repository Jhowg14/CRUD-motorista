...
var handleHomeContentHeight = function() {
  // $("#home").height($(window).height()), $(window).on("resize", function() {
...
handleHeaderNavigationState = function() {
  $(window).on("scroll load", function() {
    if ("disabled" != $("#header").attr("data-state-change")) {
      ...
      $("#header").height() <= e ? $("#header").addClass("navbar-small") : $("#header").removeClass("navbar-small")
    }
  })
},
...
handlePageContainerShow = function() {
  ...
  t = "";
  3 <= e && e < 4 ? t = "in" : 4 <= e && e < 5 && (t = "show"), $("#page-container").addClass(t)
},
...
handleHeaderScrollToAction = function() {
  $(document).on("click", "[data-click=scroll-to-target]", function(e) {
    ...
    }, 500), "dropdown" == $(this).attr("data-toggle")) {
...
App = function() {
  ...
  return {
    init: function() {
      handleHomeContentHeight(), handleHeaderNavigationState(), handlePageContainerShow(), handlePaceLoadingPlugins(), handlePageScrollContentAnimation(), handleHeaderScrollToAction(), handleTooltipActivation(), handleThemePanelExpand(), handleThemePageControl(), handleParoller()
    }
  }
}();
